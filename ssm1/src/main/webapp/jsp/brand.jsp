        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="brandForm">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9">
                            <input type="hidden" class="form-control" name="id" id="mmid">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(function () {
        //发送请求查询数据
        $.get("../brand/selectAll",function (response) {
            if(response.success){
        ...
        function show(data) {//[{"id":1,"name":"三星","firstChar":"S"},{"id":1,"name":"三星","firstChar":"S"}]
            ...
            $.each(data,function (i,e) {
                $("table tbody").append('<tr><td>'+e.id+'</td> <td>'+e.name+'</td><td>'+e.firstChar+'</td> <td> <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="updata('+e.id+')">编辑</button> <button onclick="del('+e.id+')" class="btn btn-danger">删除</button> </td> </tr>');
            })
        }
